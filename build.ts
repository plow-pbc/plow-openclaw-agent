...
for (const name of ["boot/agent-index", "boot/config", "boot/identity", "boot/log", "boot/prompt", "boot/main", "boot/process", "boot/probe", "boot/probe-fixture", "boot/mcp-bridge", "plugin/index", "plugin/transport", "plugin/buzz", "plugin/buzz-acp", "plugin/buzz-identity", "plugin/buzz-nostr"]) {
